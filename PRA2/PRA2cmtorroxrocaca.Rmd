...
El que s'ha decidit és no realitzar cap modificació, perquè aquests valors són correctes perquè es basen en dades reals sobre les temporades i les estadístiques de joc de cada un dels equips. Per tant, hem d'assumir que trobarem valors màxims i mínims en alguns casos a causa de la competició.
