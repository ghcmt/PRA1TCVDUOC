...
cor10plot <- corrplot(cor10, method = "color", col = col(200), addCoef.col = 'black', type = "upper", tl.srt = 45, tl.col = "black", tl.cex = 0.7, cl.pos = 'n', diag = F, number.font = 1, number.cex = 0.6, title = "00s",  mar=c(0,0,1,0))
