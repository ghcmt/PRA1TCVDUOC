...
# Fem el gràfic:
ggplot(data=df, aes(x=Season, y=games, fill=League)) + geom_bar(stat="identity", color="black", position=position_dodge()) +  theme_minimal() + scale_fill_brewer(palette="Blues")
```
