...
# Exercici 7: Codi.
El codi de la pràctica es troba en l'arxiu R Markdown 'PRA2cmtorroxrocaca.Rmd' pujat al GitHub. No el reproduïm aquí per falta d'espai. Cal tenir en compte, que s'ha realitzat la pràctica sobre el mateix repositori. En conseqüència, trobarem que aquest s'anomena PRA1 però conte tant els fitxers de la primera pràctica en una carpeta per separat i els fitxers de la segona més visibles.

# Exercici 8: Vídeo.
L'enllaç al vídeo es troba a FFFFFFFFFFF
