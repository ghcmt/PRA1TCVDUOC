...
kable(contDF, booktabs = TRUE, caption = "Taula de Contribucions", 
      col.names = c("Contribucions", "Signatura")) %>% 
  kable_styling(latex_options = c("striped", "hold_position"))
```
...
dfCSV <- df %>% select(Playoffs, win_loss_pct, fg, fg2, fg3, ft, pf, vars)
